...
### Цена и добавление в корзину
   1. Кнопка изменения количества товара в корзине. Требуется проверка как для авторизованного пользователя, так и неавторизованного.
         ...
         - Если пользователь авторизирован, то счетчик товара в корзине после добавления не сбрасывается после обновления страницы.
### Рекомендации
...
1. Название вкладки имеет формат '<название товара> - Отзывы, Reazon"
2. Если пользватель не авторизован открывается страница на которой содержится ссылка на [логин](https://www.reazon.ru/login)
