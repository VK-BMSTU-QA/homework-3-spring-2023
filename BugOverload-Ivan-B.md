...
### При нажатии на имя _режиссёра_, или _актёра_ должен произойти переход на страницу персоны вида _movie-gate.online/person/:id/_
...
2. Найти кнопку "+"
3. Кликнуть по ней
4. Дождаться появления сообщения об ошибке с таумаутом 2 сек.
...
4. Кликнуть по ней
5. Дождаться появления сообщения об успешности выполнения с таумаутом 2 сек.
...
10. Кликнуть по ней
11. Дождаться появления сообщения об успешности выполнения с таумаутом 2 сек.
...
9. Кликнуть по ней
10. Дождаться появления сообщения об успешности выполнения с таумаутом 2 сек.
...
6. Проверить, что имя пользователя в модалке совпадает с нашим
...
### После публикации она будет отображена сверху в области с рецензиями
1. Авторизоваться на сервисе
2. Перейти на страницу movie-gate.online/film/1
3. Найти кнопку "Написать рецензию"
4. Кликнуть по ней
...
8. Найти в модалке кнопку "Опубликовать рецензию"
9. Кликнуть по ней
10. Дождаться появления сообщения об ошибке с таумаутом 2 сек.
...
4. Имитировать ввод клавиши Enter
